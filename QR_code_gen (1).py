...
class QR_generator:
    def __init__(self,root):
        ...
        self.root.title(" QR generator | Developed By Piyush Sonar")
        self.root.resizable(False, False)

        title = Label(self.root, text="        A simple QR Code Generator                                                                                                                                                                                                                                           by Piyush Sonar ", font=('arial', 10),anchor='w').place(x=0, y=0, relwidth = 1)
...
# =====================Variables ================
        ...
        self.var_vac1_code = StringVar()
        self.var_vac2_code = StringVar()
        self.var_vac3_code = StringVar()
        self.var_vac4_code = StringVar()
        self.var_vac5_code = StringVar()
        self.var_vac6_code = StringVar()
        self.var_vac7_code = StringVar()
        self.var_vac8_code = StringVar()
...
# =============== QR CODE window ===========
        ...
        def myclick4():
            ...
            add_Frame = Frame(self.root, bd=0, relief=RIDGE, bg='black')
            add_Frame.place(x=10, y=77, width=650, height=663)
            add_bg = PhotoImage(file="Capture.png")
            add_bg_lable = Label(add_Frame, bd=0, image=add_bg).place(x=0, y=0, width=650, height=663)
            lbl_add1_code = Label(add_Frame, text="Vaccine_Name *full➤", font=("dubai medium", 15, 'bold'), bg='black', fg='white').place(x=68, y=90)
            lbl_add2_code = Label(add_Frame, text="Person_Name       ➤", font=("dubai medium", 15, 'bold'), bg='black', fg='white').place(x=68, y=144)
            lbl_add3_code = Label(add_Frame, text="Date_of_Dose      ➤", font=("dubai medium", 15, 'bold'), bg='black', fg='white').place(x=68, y=198)
            lbl_add4_code = Label(add_Frame, text="Next_Dose         ➤", font=("dubai medium", 15, 'bold'), bg='black', fg='white').place(x=68, y=252)
            lbl_add5_code = Label(add_Frame, text="Vaccinated_by     ➤", font=("dubai medium", 15, 'bold'), bg='black', fg='white').place(x=68, y=306)
            lbl_add6_code = Label(add_Frame, text="Vaccination_at    ➤", font=("dubai medium", 15, 'bold'), bg='black', fg='white').place(x=68, y=360)
            lbl_add7_code = Label(add_Frame, text="Phone             ➤", font=("dubai medium", 15, 'bold'), bg='black', fg='white').place(x=68, y=414)
            lbl_add8_code = Label(add_Frame, text="Email             ➤", font=("dubai medium", 15, 'bold'), bg='black', fg='white').place(x=68, y=468)
...
# =============== QR CODE window ===========
        ...
        st_button = Button(self.root, text=" CLICK HERE ", bd=1, command=myclick, font=("times new roman", 20),
                           bg='#FFC0CB', fg='#00008B').place(x=160, y=350, width=250, height=50)
        url_button = Button(self.root, text=" CLICK HERE ", bd=1, command=myclick1, font=("times new roman", 20),
                           bg='#FFC0CB', fg='#00008B').place(x=800, y=350, width=250, height=50)
        ct_button = Button(self.root, text=" CLICK HERE ", bd=1, command=myclick2, font=("times new roman", 20),
                           bg='#FFC0CB', fg='#00008B').place(x=160, y=560, width=250, height=50)
        add_button = Button(self.root, text=" CLICK HERE ", bd=1, command=myclick3, font=("times new roman", 20),
                           bg='#FFC0CB', fg='#00008B').place(x=800, y=560, width=250, height=50)
        add_button = Button(self.root, text=" CLICK HERE ", bd=1, command=myclick4, font=("times new roman", 20),
                           bg='#FFC0CB', fg='#00008B').place(x=570, y=699, width=250, height=50)
        root.mainloop()
    ...
    def save2(self):
        ...
        qr.make(fit=True)
        img = qr.make_image(fill_color="black", back_color="white")
        img.save("URL QRcode by Piyush.png")
        pass
    ...
    def save3(self):
        ...
        qr.make(fit=True)
        img = qr.make_image(fill_color="black", back_color="white")
        img.save("Contact QRcode by Piyush.png")
        pass
    ...
    def save4(self):
        ...
        qr.make(fit=True)
        img = qr.make_image(fill_color="black", back_color="white")
        img.save("Address QRcode by Piyush.png")
        pass
    def generate5(self):
        if self.var_add1_code.get() == "" or self.var_add2_code.get() == "" or self.var_add3_code.get() == "" or self.var_add4_code.get() == "" or self.var_add5_code.get() == "" or self.var_add6_code.get() == "" or self.var_add7_code.get() == "" or self.var_add8_code.get() == "":
            self.msg='All fields are required'
            ...
            qr.add_data(f"Vaccine_Name : {self.var_add1_code.get()}\nPerson_Name : {self.var_add2_code.get()}\nDate_of_Dose : {self.var_add3_code.get()}\nNext_Dose : {self.var_add4_code.get()}\nVaccinated_by : {self.var_add5_code.get()}\nVaccination_at : {self.var_add6_code.get()}\nPhone : {self.var_add7_code.get()}\nEmail : {self.var_add8_code.get()}")
            qr.make(fit=True)
            img = qr.make_image(fill_color="black", back_color="white")
            print(img)
    ...
    def save5(self):
        ...
        qr.make(fit=True)
        img = qr.make_image(fill_color="black", back_color="white")
        img.save("Vaccine QRcode by Piyush.png")
        pass
